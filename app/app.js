...
const {
  parse
} = __webpack_require__(/*! json2csv */ "json2csv"); // import 
...
;
vComp(["job-section", "job-screen", "error-msgs", "block-wrap", "box-results", "text-results"]); //setup Vue :: controls the front-end
