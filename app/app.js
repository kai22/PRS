...
/***/ "./node_modules/css-loader/index.js!./src/stylesheets/bootstrap.min.css":
/*!*********************************************************************!*\
  !*** ./node_modules/css-loader!./src/stylesheets/bootstrap.min.css ***!
  \*********************************************************************/
...
/* harmony import */ var _stylesheets_bootstrap_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stylesheets/bootstrap.min.css */ "./src/stylesheets/bootstrap.min.css");
/* harmony import */ var _stylesheets_bootstrap_min_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_stylesheets_bootstrap_min_css__WEBPACK_IMPORTED_MODULE_1__);
...
const R = __webpack_require__(/*! ramda/dist/ramda.min.js */ "ramda/dist/ramda.min.js");

const csv = __webpack_require__(/*! csv-parser */ "csv-parser"); // import 
...
if (fs_jetpack__WEBPACK_IMPORTED_MODULE_3___default.a.exists(desktopPath) == false) {
  desktopPath = path.join(app.getAppPath(), '../../');
}

const appDir = fs_jetpack__WEBPACK_IMPORTED_MODULE_3___default.a.cwd(path.join(desktopPath, 'PRS'));
...
const imagesDir = preferences.images; //setup neDB so we can ditch the excel sheets 
...
;
vComp(["job-section", "job-screen", "error-msgs", "block-wrap", "result-screen"]); //setup Vue :: controls the front-end
...
global.atom = new Vue({
  ...
  methods: {
    getPhotoDir: function (p) {
      if (fs_jetpack__WEBPACK_IMPORTED_MODULE_3___default.a.exists(imagesDir + p)) {
    ...
    convertCSV: function (file) {
      var vm = this;
      var result = [];
      appDir.createReadStream(file).pipe(csv()).on('data', data => result.push(data));
      return result;
    },
    monthlyJob: function () {
      let vm = this;
      let monthly = [];
      appDir.createReadStream(path.join(appDir.path(monthlyFolder), vm.jobOptions.filename)).pipe(csv()).on('data', data => monthly.push(data)).on('end', () => {
    ...
    submitJob: function () {
      ...
      if (vm.jobOptions.filename && vm.jobOptions.project && vm.jobOptions.display) {
        // && vm.jobOptions.writeCSV){
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./bootstrap.min.css */ "./node_modules/css-loader/index.js!./src/stylesheets/bootstrap.min.css");
...
/*!******************************************!*\
  !*** external "ramda/dist/ramda.min.js" ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("ramda/dist/ramda.min.js");

/***/ }),

/***/ "vue/dist/vue.min.js":
/*!**************************************!*\
  !*** external "vue/dist/vue.min.js" ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports) {
